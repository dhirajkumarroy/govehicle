 ...
 */
router.post('/', authenticateRequest, controller.createBooking);
 ...
 */
router.get('/my', authenticateRequest, controller.listCustomerBookings);
 ...
 *         description: Unauthorized access.
 */
router.get('/owner', authenticateRequest, controller.listOwnerBookings);
 ...
 *         description: Booking not found.
 */
router.patch('/:id/confirm', authenticateRequest, controller.confirmBooking);
 ...
 *         description: Booking not found.
 */
router.patch('/:id/reject', authenticateRequest, controller.rejectBooking);
 ...
 *         description: Booking not found.
 */
router.patch('/:id/cancel', authenticateRequest, controller.cancelBooking);
