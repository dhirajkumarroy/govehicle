 ...
 */
router.post('/', auth_middleware_1.authenticateRequest, upload_middleware_1.uploadVehicleImages, controller.createVehicle);
/**
 * @openapi
 * /vehicles:
 *   get:
 ...
 */
router.get('/my', auth_middleware_1.authenticateRequest, controller.listMyVehicles);
/**
 * @openapi
 * /vehicles/{id}:
 *   get:
 ...
 *         description: Vehicle not found.
 */
router.patch('/:id', auth_middleware_1.authenticateRequest, controller.updateVehicle);
/**
 * @openapi
 * /vehicles/{id}:
 *   delete:
 ...
 *         description: Vehicle not found.
 */
router.delete('/:id', auth_middleware_1.authenticateRequest, controller.deleteVehicle);
